...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $sql = "UPDATE user SET id_number = '$id_number', first_name = '$first_name', middle_name = '$middle_name', last_name = '$last_name', extension_name = '$extension', email = '$email', birthday = '$birthday', age = '$age', sex = '$sex', barangay = '$barangay', city = '$city', province = '$province', contact_number = '$contact_number' WHERE user_id = '$user_id'";
