...
<aside id="logo-sidebar" class="fixed top-0 left-0 z-40 w-64 h-full transition-transform -translate-x-full sm:translate-x-0" aria-label="Sidebar">
    <div class="h-full px-3 py-4 overflow-y-auto bg-black dark:bg-black">
        <a href="./faculty/faculty_home.php?section_id=<?php echo $section_id; ?>" class="flex items-center ps-2.5 mb-5">
        ...
        <ul class="space-y-2 font-medium">
            <li>
                <a href="./faculty/faculty_home.php?section_id=<?php echo $section_id; ?>" class="flex items-center p-2 text-white rounded-lg hover:bg-gray-100 dark:hover:bg-gray-700 group <?php echo $current_page == 'faculty_home.php' ? 'bg-active' : ''; ?>">
            ...
            <li>
                <a href="./faculty/student_information.php?section_id=<?php echo $section_id; ?>" class="flex items-center p-2 text-white rounded-lg hover:bg-gray-100 dark:hover:bg-gray-700 group <?php echo $current_page == 'student_information.php' ? 'bg-active' : ''; ?>">
            ...
            <?php if ($_SESSION['user_type'] == 'nstp_coordinator'): ?>
                <li>
                    <a href="./faculty/faculty_information.php?section_id=<?php echo $section_id; ?>" class="flex items-center p-2 text-white rounded-lg hover:bg-gray-100 dark:hover:bg-gray-700 group <?php echo $current_page == 'faculty_information.php' ? 'bg-active' : ''; ?>">
            ...
            <?php endif; ?>
            <li>
                <a href="./faculty/section_code.php?section_id=<?php echo $section_id; ?>" class="flex items-center p-2 text-white rounded-lg hover:bg-gray-100 dark:hover:bg-gray-700 group <?php echo $current_page == 'section_code.php' ? 'bg-active' : ''; ?>">
                    <svg class="w-5 h-5 text-gray-500 transition duration-75 dark:text-gray-400 group-hover:text-gray-900 dark:group-hover:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="200" height="200" viewBox="0 0 512 512">
            ...
            <li>
                <a href="./activities.php?section_id=<?php echo $section_id; ?>" class="flex items-center p-2 text-white rounded-lg hover:bg-gray-100 dark:hover:bg-gray-700 group <?php echo $current_page == 'activities.php' ? 'bg-active' : ''; ?>">
            ...
            <?php if ($_SESSION['user_type'] == 'nstp_coordinator'): ?>
            <li>
                <a href="./faculty/archived_classes.php?section_id=<?php echo $section_id; ?>" class="flex items-center p-2 text-white rounded-lg hover:bg-gray-100 dark:hover:bg-gray-700 group <?php echo $current_page == 'archived_classes.php' ? 'bg-active' : ''; ?>">
                    <svg class="w-5 h-5 text-gray-500 transition duration-75 dark:text-gray-400 group-hover:text-gray-900 dark:group-hover:text-white" xmlns="http://www.w3.org/2000/svg" width="200" height="200" viewBox="0 0 16 16"><path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M1.75 2.75h12.5v3.5H1.75zm5 6.5h2.5m-6.5-2.5v7.5h10.5v-7.5"/></svg>
                    <span class="ms-3">Archived</span>
                </a>
            </li>
            <?php endif; ?>
            <li>
                <a href="./faculty/profile.php?section_id=<?php echo $section_id; ?>&user_id=<?php echo $user_id; ?>" class="flex items-center p-2 text-white rounded-lg hover:bg-gray-100 dark:hover:bg-gray-700 group <?php echo $current_page == 'profile.php' ? 'bg-active' : ''; ?>">
                    <svg class="w-5 h-5 text-gray-500 transition duration-75 dark:text-gray-400 group-hover:text-gray-900 dark:group-hover:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="200" height="200" viewBox="0 0 512 512">
            ...
            <li>
                <form method="POST">
                    <a href="./logout.php" class="w-full flex items-center p-2 text-white rounded-lg hover:bg-gray-100 dark:hover:bg-gray-700 group">
                        <svg class="w-5 h-5 text-gray-500 transition duration-75 dark:text-gray-400 group-hover:text-gray-900 dark:group-hover:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="200" height="200" viewBox="0 0 512 512">
