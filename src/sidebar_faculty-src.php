    ...
    <div class="h-full px-3 py-4 overflow-y-auto bg-black dark:bg-black">
        ...
        <ul class="space-y-2 font-medium">
            ...
            <?php if ($_SESSION['user_type'] == 'nstp_coordinator'): ?>
                ...
                <li>
                    <a href="./faculty/sections.php?section_id=<?php echo $section_id; ?>" class="flex items-center p-2 text-white rounded-lg hover:bg-gray-100 dark:hover:bg-gray-700 group <?php echo $current_page == 'sections.php' ? 'bg-active' : ''; ?>">
