<aside id="logo-sidebar" class="fixed top-0 left-0 z-40 w-64 h-full transition-transform -translate-x-full sm:translate-x-0" aria-label="Sidebar">
    <div class="h-full px-3 py-4 overflow-y-auto bg-black dark:bg-black">
        ...
        <ul class="space-y-2 font-medium">
            <li>
                <a href="./student_home.php?section_id=<?php echo $section_id; ?>" class="flex items-center p-2 text-white rounded-lg hover:bg-gray-100 dark:hover:bg-gray-700 group <?php echo $current_page == 'student_home.php' ? 'bg-active text-black' : ''; ?>">
            ...
            <li>
                <a href="./profile.php?section_id=<?php echo $section_id; ?>&user_id=<?php echo $user_id; ?>" class="flex items-center p-2 text-white rounded-lg hover:bg-gray-100 dark:hover:bg-gray-700 group <?php echo $current_page == 'profile.php' ? 'bg-active text-black' : ''; ?>">
                    <svg class="w-5 h-5 text-gray-500 transition duration-75 dark:text-gray-400 group-hover:text-gray-900 dark:group-hover:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="200" height="200" viewBox="0 0 512 512">
