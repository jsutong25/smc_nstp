...
<aside id="logo-sidebar" class="fixed top-0 left-0 z-40 w-64 h-full transition-transform -translate-x-full sm:translate-x-0" aria-label="Sidebar">
    <div class="h-full px-3 py-4 overflow-y-auto bg-black dark:bg-black">
        ...
        <ul class="space-y-2 font-medium">
            <li>
                <a href="./faculty_home.php?section_id=<?php echo $section_id; ?>" class="flex items-center p-2 text-white rounded-lg hover:bg-gray-100 dark:hover:bg-gray-700 group <?php echo $current_page == 'faculty_home.php' ? 'bg-active' : ''; ?>">
            ...
            <li>
                <a href="./student_information.php?section_id=<?php echo $section_id; ?>" class="flex items-center p-2 text-white rounded-lg hover:bg-gray-100 dark:hover:bg-gray-700 group <?php echo $current_page == 'student_information.php' ? 'bg-active' : ''; ?>">
            ...
            <?php if ($_SESSION['user_type'] == 'nstp_coordinator'): ?>
                <li>
                    <a href="./faculty_information.php?section_id=<?php echo $section_id; ?>" class="flex items-center p-2 text-white rounded-lg hover:bg-gray-100 dark:hover:bg-gray-700 group <?php echo $current_page == 'faculty_information.php' ? 'bg-active' : ''; ?>">
            ...
            <?php if ($_SESSION['user_type'] == 'nstp_coordinator'): ?>
            <li>
                <a href="./archived_classes.php?section_id=<?php echo $section_id; ?>" class="flex items-center p-2 text-white rounded-lg hover:bg-gray-100 dark:hover:bg-gray-700 group <?php echo $current_page == 'archived_classes.php' ? 'bg-active' : ''; ?>">
