            ...
            <div class="mx-auto w-full sm:w-[500px] md:w-[600px] h-[65vh] content-center flex-grow p-4 sm:ml-[210px]">
                ...
                <div class="">
                    <form action="" class="flex flex-col" method="POST">
                        ...
                        <select class="bg-bg border-2 border-white rounded-full py-3 mt-2 mb-2" style="padding-left: 2em; padding-right: 2em;" name="schedule" required>
                            <option value="<?php echo htmlspecialchars($section['schedule']); ?>"><?php echo htmlspecialchars($section['schedule']); ?></option>
